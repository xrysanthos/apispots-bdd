...
var SwaggerApiDefinition = (function( ApiDefinition ) {
	 ...
	 */
	ApiDefinition.parse = function( url, cb ){
		try {
...
// op.scheme = (typeof ApiDefinition.spec.schemes !== 'undefined' ?
// ApiDefinition.spec.schemes[0] : 'http' );
			op.baseUrl = ApiDefinition.spec.host + ApiDefinition.spec.basePath;
			op.path = ref.path;
